...
/**
 * Gestionnaire pour récupérer les activités d'un compte CyberArk spécifique
...
export async function GET(
  ...
  try {
    ...
    const apiEndpoint = CYBERARK_ENDPOINTS.ACCOUNTS.ACTIVITIES.replace("{id}", accountId);
    ...
    console.error("Erreur lors de la récupération des activités du compte:", error);
