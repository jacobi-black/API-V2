...
/**
 * Gestionnaire pour récupérer les plateformes CyberArk
...
export async function GET(request: NextRequest) {
  try {
    ...
    let apiUrl = `${ensureTrailingSlash(baseUrl)}${CYBERARK_ENDPOINTS.PLATFORMS.LIST}`;
    ...
    if (active) cyberArkParams.append("active", active);
