 ...
 */
export function exportData<T>(data: T, options: ExportOptions = {}): ExportResult {
  const {
    format = "json",
 ...
 */
export function canExportAsCsv<T>(data: T): boolean {
 ...
 */
export function prepareExportData<T>(data: ApiData<T> | T): T | unknown {
